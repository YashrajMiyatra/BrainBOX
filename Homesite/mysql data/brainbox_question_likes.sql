...
CREATE TABLE `question_likes` (
  ...
  CONSTRAINT `question_likes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `question_likes_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
...
INSERT INTO `question_likes` VALUES (45,35,70,1,'2024-02-16 10:02:03');
