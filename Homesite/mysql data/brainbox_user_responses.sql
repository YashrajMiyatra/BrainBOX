...
CREATE TABLE `user_responses` (
  ...
  CONSTRAINT `user_responses_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `user_responses_ibfk_2` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
