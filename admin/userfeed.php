...
$result = $mysqli->query("SELECT question_date, COUNT(*) AS total_questions FROM question GROUP BY question_date");
...
var totalUsers = <?php echo json_encode($totalquestion); ?>;
...
userChart.data.datasets[0].data = [totalquestions[index]];
